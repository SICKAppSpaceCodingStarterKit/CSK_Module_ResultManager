...
export function changeStyle(theme) {
  ...
  if (theme == 'CSK_Style'){
    ...
    var customBackground =  `.CSK_Module_ResultManager .myCustomBackground_CSK_Module_ResultManager { background-color: #737F8522; }` // font-family: "Open Sans"; }`
    ...
    var customBackground =  `.CSK_Module_ResultManager .myCustomBackground_CSK_Module_ResultManager { background-color: #fff; }` // font-family: "sans-serif"; }`
